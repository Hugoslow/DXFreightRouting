...
# ===========================================
# DEPOT DATA UPDATE - ADD THIS TO main.py
# ===========================================
# 
# Add this code AFTER this line in main.py:
#     app = FastAPI(title="DX Freight Routing System")
#
# Once you've updated the data, DELETE this code and push again.
# ===========================================

@app.get("/update-depots")
def update_depots(db: Session = Depends(get_db)):
    """Temporary endpoint to update depot D numbers and capacities"""
